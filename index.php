    ...
    <div class="row">
        <div class="col-12">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark h2">
                <a class="navbar-brand" data-aos="fade-up" data-aos-duration="1000" href="index.php">Sensor Monitoring System</a>
            ...
            <div class="row mb-5">
                <div class="col-2">
                    ...
                    <div class="vertical-nav bg-white" data-aos="fade-right" data-aos-duration="1000" id="sidebar">
                ...
                if($page=="temp_log"){
                    ...
                    echo "  <div class='row'  data-aos='fade-up' data-aos-duration='1000'>
                            ...
                            <div class='row justify-content-center' data-aos='fade-down' data-aos-duration='1000'>
                                <img style='height: 400px; width: 400px;' src='image/temp.jpg' alt='image'>
                            </div> ";   
            ...
            <footer>
                <div class="row alert alert-primary my-0" data-aos='fade-up' data-aos-duration='1000'>
